...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    '  the picture should SHOW — subject, setting, season, mood, action.',
  ...
  function draftPrompt(bodyHtml) {
    ...
    // v1.0.3 — prepend the publisher's Notes when the upload carried them.
    var notes = publisherNotes();
    var userContent = notes
  ...
  function notesBlock() {
    ...
    if (!n) return '';
    return '<div class="ixig-notes">' +
             '<span class="ixig-notes-h">Publisher notes \u00b7 fed to the prompt</span>' +
