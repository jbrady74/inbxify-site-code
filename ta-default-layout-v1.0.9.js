...
(function () {
    ...
    S.root.innerHTML =
      ...
      '<div class="tdl-grid">' +
        ...
        '<div class="tdl-stack-wrap">' +
          ...
          // 65% width to match tiles, 80px tall, #142e2e, white Fraunces, top
          // corners rounded 5px. Not CMS-bound (token resolution failed); make
          // per-title later if needed.
          '<div class="tdl-fixed-mast">Wyckoff Living Now</div>' +
  ...
  function mount() {
    ...
    render();
    S.mounted = true;
    console.log('[tdl] Default Layout tab mounted \u00b7 v1.0.9 \u00b7 blocks:', S.blocks.length,
