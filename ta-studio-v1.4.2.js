...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function attachHeadingInfo(name) {
      ...
      (function tick() {
        tries++;
        // Heading candidates, in priority order.
        var heading = body.querySelector('.cmp-title, .std-panel-title, h1, h2, .asm-title');
        if (heading) {
          if (!heading.querySelector('.std-heading-info')) {
        ...
        if (tries < 12) setTimeout(tick, 60);
      })();
    }
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.4.2 mounted \u2014 panel headings now carry a superscript \u24d8 info popover (TAB_INFO registry: description + Make scenarios per tab). Create launcher unchanged from v1.4.1.');
  });
