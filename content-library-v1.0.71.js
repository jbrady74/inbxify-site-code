...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function render() {
    ...
    var _clBtn = '<button class="cl-btn" onclick="window.location.hash=\'content-library\';window.location.reload()" style="font-size:10px;padding:5px 12px">\u21BB Refresh</button>';
