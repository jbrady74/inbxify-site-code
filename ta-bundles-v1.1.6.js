/* ============================================================
   ta-bundles-v1.1.6.js
   ============================================================
   INBXIFY · Bundles Workspace · Cut 2 post-launch fixes
   (Scenario K validation gating + 2-column cascade UX)
   ...
   ─── Page load order on T-A page ───
     ...
     3. ta-bundles-v1.1.6.js             (this file)
     4. ta-bundles-v1.1.6.css            (paired — full replacement
                                          of v1.1.5.css; remove the
                                          old <link>)
