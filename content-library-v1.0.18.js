...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-thead{display:grid;grid-template-columns:1.2fr 1fr 1.8fr 60px;gap:0;border-bottom:2px solid #1a3a3a;padding:6px 0;align-items:end}',
    ...
    '.cl-card-main{display:grid;grid-template-columns:1.2fr 1fr 1.8fr 60px;gap:0;align-items:center;padding:11px 0;cursor:pointer}',
