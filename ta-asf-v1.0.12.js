...
(function () {
      ...
      '<section class="asf-row">' +
        ...
        '<div style="display:flex;align-items:center;gap:14px;padding:10px 18px;background:#fff;border-bottom:1px solid var(--tile-border);">' +
          ...
          '<div style="margin-left:auto;">' +
            (S.mode === 'create'
              ? '<button type="button" class="asf-edit-body-btn" disabled' +
                  ' style="opacity:0.45;cursor:not-allowed;" title="Save draft first to create the article record, then edit body">' +
                  '✎ Save draft first to enable body editor' +
                '</button>'
  ...
  log('mounted · v' + VERSION + ' · Create-mode triple bugfix: (1) Save Draft reads from dirtyFields not S.article (2) Edit body button disabled in create mode w/ msg (3) CMS-ref pickers wired (CSS pointer-events fix in companion v1.0.12 css)');
})();
