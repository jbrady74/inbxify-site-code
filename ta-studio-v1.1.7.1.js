// ============================================================
// ta-studio-v1.1.7.1.js
// INBXIFY TA Studio — Components tab (patch: drawer body-hoist)
//
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Init ──
    renderAssembler();
    console.log('\u29BE Studio v1.1.7.1 mounted \u2014 Components tab (drawer body-hoist stacking fix)');
  });
