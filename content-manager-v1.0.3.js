// ============================================================
// content-manager-v1.0.3.js
// INBXIFY Content Manager — System 2 UI
// v1.0.3: Ad, Event, RE Listing inline creation forms added
// ============================================================
...
<div class="cm-root">
  ...
  function renderAssignPanel() {
    ...
    if (col !== 'customers') {
      ...
      if (A.isNew) {
        // ── Full creation form — varies by collection ──
        if (col === 'articles') {
          h += `
          <div style="background:#f5f3ee;border:1.5px solid #e8e4d8;border-radius:4px;padding:14px;margin-bottom:10px">
            ...
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Writer Name</label>
                <input class="cm-finp ${A.newWriterName?'changed':''}" type="text" value="${esc(A.newWriterName)}" oninput="A.newWriterName=this.value" placeholder="Name…">
              </div>
              <div class="cm-ff">
                <label class="cm-fl">Writer Title</label>
                <input class="cm-finp ${A.newWriterTitle?'changed':''}" type="text" value="${esc(A.newWriterTitle)}" oninput="A.newWriterTitle=this.value" placeholder="Role…">
              </div>
              <div class="cm-ff">
                <label class="cm-fl">Co-Writer Name</label>
                <input class="cm-finp ${A.newCoWriterName?'changed':''}" type="text" value="${esc(A.newCoWriterName)}" oninput="A.newCoWriterName=this.value" placeholder="Optional…">
              </div>
              <div class="cm-ff">
                <label class="cm-fl">Co-Writer Title</label>
                <input class="cm-finp ${A.newCoWriterTitle?'changed':''}" type="text" value="${esc(A.newCoWriterTitle)}" oninput="A.newCoWriterTitle=this.value" placeholder="Optional…">
              </div>
            </div>

            <!-- Extras section -->
            <div style="border-top:1px dashed #ddd9c8;margin-top:8px;padding-top:8px">
              <button class="cm-link-btn" onclick="A.newExtrasOpen=!A.newExtrasOpen;render()" style="font-size:10px">
                ${A.newExtrasOpen?'▾':'▸'} Additional fields
              </button>
              ${A.newExtrasOpen ? `
              <div style="margin-top:10px">
                <div class="cm-fr">
                  <div class="cm-ff">
                    ...
                    <input class="cm-finp ${A.newBannerStatement?'changed':''}" type="text" value="${esc(A.newBannerStatement)}" oninput="A.newBannerStatement=this.value" placeholder="Optional banner text…">
                  </div>
                </div>
                ...
                ${A.newPhotoCredits ? `
                <div class="cm-fr" style="margin-top:8px">
                  <div class="cm-ff">
                    <label class="cm-fl">Photographer</label>
                    <input class="cm-finp ${A.newPhotographer?'changed':''}" type="text" value="${esc(A.newPhotographer)}" oninput="A.newPhotographer=this.value" placeholder="Photographer name…">
                  </div>
                </div>` : ''}
                ${A.newVideoArticle ? `
                <div class="cm-fr" style="margin-top:8px">
                  <div class="cm-ff">
                    <label class="cm-fl">Video URL</label>
                    <input class="cm-finp ${A.newVideoUrl?'changed':''}" type="text" value="${esc(A.newVideoUrl)}" oninput="A.newVideoUrl=this.value" placeholder="https://…">
                  </div>
                </div>` : ''}
                <div class="cm-fr" style="margin-top:8px">
                  <div class="cm-ff">
                    <label class="cm-fl">Audio URL</label>
                    <input class="cm-finp ${A.newAudioUrl?'changed':''}" type="text" value="${esc(A.newAudioUrl)}" oninput="A.newAudioUrl=this.value" placeholder="https://…">
                  </div>
                </div>
              </div>` : ''}
            </div>
          ...
          <div style="background:#f5f3ee;border:1.5px solid #e8e4d8;border-radius:4px;padding:14px;margin-bottom:10px">
            ...
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Start Date</label>
                <input class="cm-finp changed" type="date" value="${A.newAdStartDate}" oninput="A.newAdStartDate=this.value">
              </div>
              <div class="cm-ff">
                <label class="cm-fl">End Date</label>
                <input class="cm-finp changed" type="date" value="${A.newAdEndDate}" oninput="A.newAdEndDate=this.value">
              </div>
            </div>
          </div>
          <div style="margin-bottom:8px"><button class="cm-link-btn" onclick="cmBackToExisting()">← back to existing</button></div>`;
          ...
          <div style="background:#f5f3ee;border:1.5px solid #e8e4d8;border-radius:4px;padding:14px;margin-bottom:10px">
            ...
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Location</label>
                <input class="cm-finp ${A.newEventLocation?'changed':''}" type="text" value="${esc(A.newEventLocation)}" oninput="A.newEventLocation=this.value" placeholder="Venue name…">
              </div>
              <div class="cm-ff">
                <label class="cm-fl">City</label>
                <input class="cm-finp ${A.newEventCity?'changed':''}" type="text" value="${esc(A.newEventCity)}" oninput="A.newEventCity=this.value" placeholder="City…">
              </div>
            </div>
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Address</label>
                <input class="cm-finp ${A.newEventAddress?'changed':''}" type="text" value="${esc(A.newEventAddress)}" oninput="A.newEventAddress=this.value" placeholder="Street address…">
              </div>
            </div>
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Description</label>
                <input class="cm-finp ${A.newEventDescription?'changed':''}" type="text" value="${esc(A.newEventDescription)}" oninput="A.newEventDescription=this.value" placeholder="Brief description…">
              </div>
            </div>
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Event Link</label>
                <input class="cm-finp ${A.newEventLink?'changed':''}" type="text" value="${esc(A.newEventLink)}" oninput="A.newEventLink=this.value" placeholder="https://…">
              </div>
            </div>
          </div>
          <div style="margin-bottom:8px"><button class="cm-link-btn" onclick="cmBackToExisting()">← back to existing</button></div>`;
          ...
          <div style="background:#f5f3ee;border:1.5px solid #e8e4d8;border-radius:4px;padding:14px;margin-bottom:10px">
            ...
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Listing Agent (Customer) <span class="req">*</span></label>
                <select class="cm-fsel ${A.customerId?'changed':''}" onchange="cmSetCust(this.value)">
              ...
              <div class="cm-ff">
                ...
                <select class="cm-fsel ${A.newReListingStatus?'changed':''}" onchange="A.newReListingStatus=this.value">
            ...
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">MLS #</label>
                <input class="cm-finp ${A.newReMls?'changed':''}" type="text" value="${esc(A.newReMls)}" oninput="A.newReMls=this.value" placeholder="MLS number…">
              </div>
              <div class="cm-ff">
                <label class="cm-fl">Price</label>
                <input class="cm-finp ${A.newRePrice?'changed':''}" type="number" value="${A.newRePrice}" oninput="A.newRePrice=this.value" placeholder="549000">
              </div>
            </div>
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Property Features</label>
                <input class="cm-finp ${A.newReFeatures?'changed':''}" type="text" value="${esc(A.newReFeatures)}" oninput="A.newReFeatures=this.value" placeholder="3BR, 2BA, 2-car garage…">
              </div>
            </div>
            <div class="cm-fr">
              <div class="cm-ff">
                <label class="cm-fl">Listing Link</label>
                <input class="cm-finp ${A.newReListingLink?'changed':''}" type="text" value="${esc(A.newReListingLink)}" oninput="A.newReListingLink=this.value" placeholder="https://…">
              </div>
            </div>
          </div>
          <div style="margin-bottom:8px"><button class="cm-link-btn" onclick="cmBackToExisting()">← back to existing</button></div>`;
          ...
          // Fallback — simple name input for any other collection
