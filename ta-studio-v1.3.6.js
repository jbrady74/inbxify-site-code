  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function openBodyEditor(articleItemId, articleTitle, opts) {
      ...
      if (!window.InbxRTE || typeof window.InbxRTE.openFullscreen !== 'function') {
        ...
        console.error('[TA-STUDIO] window.InbxRTE not available. Is ta-rte-v1.1.10.js loaded on this page?');
        alert('Body editor is not loaded. Make sure ta-rte-v1.1.10.js is loaded on this page.');
        return;
      }
      if (!articleItemId) {
