  ...
  class InbxRTE {
    ...
    injectStyles() {
      ...
      style.textContent = `
        ...
        trix-editor.rte-trix-editor h2 { font-family:'Fraunces',Georgia,serif; font-size:24px; font-weight:600; line-height:1.25; color:#1A3A3A; margin:32px 0 12px; }
        trix-editor.rte-trix-editor h3 { font-family:'Fraunces',Georgia,serif; font-size:19px; font-weight:600; line-height:1.3; color:#1A3A3A; margin:24px 0 10px; }
