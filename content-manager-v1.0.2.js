// ============================================================
// content-manager-v1.0.2.js
// INBXIFY Content Manager — System 2 UI
// v1.0.2: full inline Article creation form in Step 3
//         Revenue Type options (Paid Ad, Paid Article, Sponsorable)
//         Extras section (Photo Credits, Photo Essay, Video, Audio)
//         cmsItemId empty = new record required (isNew logic)
// ============================================================
    ...
    if (col !== 'customers') {
      ...
      if (A.isNew) {
        ...
        if (col === 'articles') {
          ...
          // Non-article collections — simple name input for now
