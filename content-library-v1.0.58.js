...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-thead{display:grid;grid-template-columns:400px 300px 200px 200px 170px;gap:0;border-bottom:2px solid #1a3a3a;padding:6px 0;align-items:end}',
    '.cl-th{font-family:"DM Mono",monospace;font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:var(--ix-text-dark,#1e2a3a);padding:0 10px}',
    ...
    '.cl-card-main{display:grid;grid-template-columns:400px 300px 200px 200px 170px;gap:0;align-items:center;padding:11px 0;cursor:pointer}',
    ...
    '.cl-thead .cl-th{color:var(--ix-text-dark,#1e2a3a)}',
  ...
  function render() {
    ...
    h += '<div class="cl-th">Newsletter</div>';
  ...
  function init() {
    ...
    console.log('[ASSET-LIBRARY v1.0.58] Init:', {
