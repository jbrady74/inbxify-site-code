...
(function () {
  ...
  function headHtml(right, extra) {
    ...
    return window.IxHeader.render({
      ...
      /* v3.2.2 — three strings carry this name: here, the fallback
         <h2> above, and the breadcrumb below. Keep them in step. */
  ...
  function showBoard() {
    ...
    S.root.innerHTML =
      '<div class="tpi-crumb">' +
        '<button type="button" class="tpi-back" data-tpi-back="1">\u2039 Print Issue Allocator</button>' +
