...
Extract and return ONLY valid JSON — no preamble, no backticks, no markdown:
{
  ...
  "teaser": "Engaging newsletter teaser, 400 characters MAX — count carefully, no truncation",
  "shortsummary": "One-liner, 150 characters MAX",
  "body": "Full article as clean HTML. <h2> for section headers. <p> for paragraphs. <ul><li> for lists. No inline styles. No wrapper divs. Start directly with content."
}`;
