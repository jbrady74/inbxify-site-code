...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var TAB_INFO = {
      ...
      generator: {
        title: 'Generate',
        desc: 'Coming later — derive title, teaser, and summary fields from article body text using AI.',
        scenarios: [
          { name: 'Scenario L — Generate MEDIA Content', route: 'generateMedia', webhook: 'TA_CONFIG.makeGenerateMedia', notes: 'AI generation of media content. Planned.' }
        ]
      }
    };
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.4.7 mounted \u2014 tab labels switched to verb forms (Assemble / Transcribe / Convert / Generate); data-std-panel keys unchanged so routing/dispatch untouched. Components + Intake labels unchanged.');
  });
