...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          ...
          '<div class="ix-hdr-right">' +
            ...
            '<span class="ix-badge">v1.3.1</span>' +
          '</div>' +
        '</div>' +
    ...
    // v1.3.1: kick off folder-counts polling for the triage banner.
    // Initial fire on Studio mount; banner appears if PDFs are
    // already pending.
    loadStudioFolderCounts();
    console.log('\u29BE Studio v1.3.1 mounted \u2014 6-tab shell + PDF triage banner (S14 Step 1). Components surface delegated to InbxComponentsTab via std:panel:components. Banner gates on STD_MONITOR.preprocessing > 0; modal mounts to <body>. Companion module: ix-modals-v1.0.1.css.');
  });
