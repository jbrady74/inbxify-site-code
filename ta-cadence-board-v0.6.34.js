...
/* D-CB-21 — manual. Each mode is a declarative column arrangement,
  ...
  function nextBar() {
    ...
    var src = n ? (S.slate[0].source || '') : '';
    var pages = 0;
    for (var i = 0; i < n; i++) if (S.slate[i].page > pages) pages = S.slate[i].page;
    ...
    var placeholder = src || 'Untitled cadence board';
  ...
  function heroHtml(panel) {
    var srcName = S.slate.length ? (S.slate[0].source || '') : '';
    var cover   = S.slate.length ? (S.slate[0].cover  || '') : '';
