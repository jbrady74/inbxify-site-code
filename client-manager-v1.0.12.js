...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function getCss() {
    return [
      ...
      // Modal
      '.cm-ov{position:fixed;inset:0;background:rgba(26,58,58,0.45);display:flex;align-items:flex-start;justify-content:center;padding:30px 16px;z-index:99999;overflow-y:auto;-webkit-overflow-scrolling:touch}',
