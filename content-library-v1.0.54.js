...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-thead{display:grid;grid-template-columns:minmax(0,1.1fr) minmax(0,0.9fr) 180px 180px 170px;gap:0;border-bottom:2px solid #1a3a3a;padding:6px 0;align-items:end}',
    ...
    '.cl-card-main{display:grid;grid-template-columns:minmax(0,1.1fr) minmax(0,0.9fr) 180px 180px 170px;gap:0;align-items:center;padding:11px 0;cursor:pointer}',
  ...
  function render() {
    ...
    if (!items.length) {
      ...
      items.forEach(function (item) {
        ...
        // Col 3: PUBPLAN (planning-stage assignment). Shows the PubPlan an asset
        // is assigned to (publication-plan ref), or armed-but-unsaved, or a dash.
        ...
        // Col 4: NEWSLETTER (edition assignment, post-promote). Shows the
        // newsletter edition an asset has been proliferated into, or a dash.
        h += '<div class="cl-cell cl-assign">';
        ...
        // Col 5: Action buttons — Assign (Article/Event/RE) + View.
  ...
  function init() {
    ...
    console.log('[CONTENT-LIBRARY v1.0.54] Init:', {
