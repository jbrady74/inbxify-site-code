/* ============================================================
   ta-bundles-v1.1.1.js
   ============================================================
   INBXIFY · Bundles Workspace · Cut 2 ship 1.5 of 3
   (Selection + cascade shell polish — bug fixes only, no
   functional changes from v1.1.0)
   ...
   ─── Page load order on T-A page ───
     ...
     2. ta-bundles-v1.1.1.js             (this file)
     3. ta-bundles-v1.1.1.css            (paired — full replacement
                                          of v1.1.0.css; remove the
                                          old <link>)
...
(function () {
  ...
  // v1.1.0 returns ALL assets of the given type from Scenario I response.
  // v1.1.1 will layer a two-hop tenant filter on top
  // (asset → titles[] → check title-admin === S.tenantId).
