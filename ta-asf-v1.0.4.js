...
(function () {
  ...
  log('mounted · v' + VERSION + ' · Picker + attach (Scenario G) + upload (Uploadcare → Scenario B) + CMS-ref edit (TD-178) wired. Generate stays as placeholder until image-gen endpoint is decided. Make routes needed: detachComponent, updateArticleRef, createMediaFromBrowserUpload.');
})();
