 ...
 * Lead Ad appears first. All ads (including SBA-1) cycle for remaining slots.
 * Label: "Local Partners"
 *
 * v1.1 — April 3, 2026 — MutationObserver + full pool rotation
 */
(function () {
  "use strict";
  ...
  function inject() {
    ...
    var leadAd = ads[0];
    var pool = ads; /* all ads rotate after the lead */
