...
(function () {
  ...
  log('mounted · v' + VERSION + ' · Create flow now targets Scenario 104 (Create Assets) via TA_CONFIG.makeCreateAssets. Payload: {action:"createAsset", assetType:"article", ...}. Response shape: {ok:true, assetType, itemId}.');
})();
