...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.ix-arf-srcwrap{position:relative;flex:1 1 380px;min-width:280px;max-width:560px;',
        'border:1px solid #e2ddcd;border-radius:8px;overflow:hidden;background:#fff !important;line-height:0;}',
  ...
  function drawSourceToCanvas() {
    ...
    if (!cv || !S.img) return;
    cv.width = S.img.naturalWidth || S.img.width;
    cv.height = S.img.naturalHeight || S.img.height;
