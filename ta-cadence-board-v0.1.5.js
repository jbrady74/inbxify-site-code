/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.1.5.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.1.5.css (matched pair — load both)

   ── v0.1.5 — CONTROLS COLLAPSE TO ICONS ──
...
(function () {
  ...
  function renderLane(laneId) {
    ...
    if (inp) inp.classList.toggle('ixcb-has', has);
  }
