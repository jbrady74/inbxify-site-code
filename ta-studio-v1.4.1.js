...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.4.1 mounted \u2014 Create launcher now opens all four ASF variants (Article / Ad / RE Listing / Event) via window.InbxASF.open({mode:"create", assetType}); companion ta-asf-v1.2.3+. window.InbxStudioBodyEditor still accepts {mode:"local"} for ASF create-mode body editing without Scenario G (caller passes initialBody + onSave). Existing edit-mode contract unchanged.');
  });
