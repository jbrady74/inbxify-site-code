    ...
    host.innerHTML =
      '<div class="ix-modal" role="dialog" aria-modal="true" aria-labelledby="a2-up-t">' +
        ...
        '<div class="ix-modal-body">' +
          ...
          row('2', 'Stored on Uploadcare, exactly as you sent it',
            'Uploadcare is the image host. The original is kept as is; the sizes and crops the site shows are made from it on the fly.') +
          row('3', 'Filed as a MEDIA item by Scenario B',
            'Scenario B (the file handler) creates one MEDIA item: named after your file (the file name plus a short code), ' +
