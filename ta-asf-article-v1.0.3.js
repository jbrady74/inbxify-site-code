...
(function () {
  ...
  function customizeToolbar() {
    ...
    up.setAttribute('data-asf-action', 'upload-rail');   // ta-asf opens its file picker
  ...
  function handle(type, e) {
    ...
    if (type === 'click') {
      ...
      if (act === 'upload-body') { uploadIntoBody(); return false; }   // ta-asf's upload-rail runs next
