// ============================================================
// pubplan-overview-v1.0.6.js
//
// v1.0.5: Header injected from JS — matches Content Processor.
//         Icon + title + subtitle left, Add PubPlan button right,
//         teal underline. Deleted Webflow-native header elements.
...
(function () {
  ...
  function render() {
    ...
    // Inject header before the scroll area
    scrollArea.insertAdjacentHTML('beforebegin', renderHeader());
