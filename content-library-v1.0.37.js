...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-searchbox{position:relative;flex:1 1 520px;max-width:640px;margin-bottom:0}',
    ...
    '.cl-search-input{width:100%;box-sizing:border-box;font-family:"DM Sans",system-ui,sans-serif;font-size:14px;padding:11px 14px 11px 44px;border:1.5px solid #e3dfd2;border-radius:10px;background:#fff;color:#1a3a3a;outline:none;transition:border-color .15s,box-shadow .15s}',
