/* ============================================================
   ta-converter-v1.0.0.js → ta-converter-v1.0.1.js
...
(function () {
  ...
  console.log('\u21BB InbxConverter v' + VERSION + ' loaded (S13 Step 3 polish — standalone module; ix-btn migration; self-mounts on std:panel:converter)');
})();
