/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.6.18.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.6.17.css — INDEPENDENTLY VERSIONED.
...
/* D-CB-21 — manual. Each mode is a declarative column arrangement,
    ...
    return '<div class="ixcb-hero">' +
      ...
      '<div class="ixcb-setup">' +
        '<div class="ixcb-gate">' +
          ...
          '</div>' +
          '<div class="ixcb-gate-ro">' + esc(prov) +
            ' Every field is editable \u2014 override any of it. Nothing is created until Create these.' +
          '</div>' +
        '</div>' +
      '</div>' +
    '</div>';
  ...
  function overviewBody() {
    ...
    var note = issues.length
      ...
      : 'Read from the print PDF. Nothing is an asset yet and no issues exist, so assignment is closed \u2014 create the issues above to open it.';
