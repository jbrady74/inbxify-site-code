...
//     with class `.article-body-source` (class lives directly
//     on the Rich Text Block). Webflow cannot bind RTE to a
//     data-attribute.
...
//       .article-flag-video-article
//     Webflow cannot bind Switch to data-attribute.
//   - Main image reads `data-article-main-image-src` bound to
//     🟡 Main Image GET Link (bare URL). NO transformation
//     applied — the URL is displayed as-is. If the URL needs
//     transformation later, add it via TA_CONFIG config and
//     post-process in the URL builder.
//
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Init ──
    renderAssembler();
    console.log('\u29BE Studio v1.0.1 mounted — Phase 1 (read-only Articles)');
  });
