...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── State ──
    var S = {
      panel: 'components',    // input | components | assembler — v1.3.5: default flipped assembler→components
      ...
      '<div class="std-root">' +
        ...
        '<div class="std-subtabs">' +
          '<button class="ix-btn ix-btn--tab" data-std-panel="input">' +
            '<span>Intake</span>' +
          '</button>' +
          '<button class="ix-btn ix-btn--tab active" data-std-panel="components">' +
        ...
        '<div class="std-panel active" data-std-panel-body="components">' +
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.4.8 mounted \u2014 Generate tab renamed to "Ad Reformat" (key generator, reformatter unchanged); NEW "Generate" tab (key adgen, dispatches std:panel:adgen, mounts #std-adgen-mount) for the from-scratch ad creator.');
  });
