/* ============================================================
   ...
   v1.2.1: robust JSON extraction — regex pull of first {...} block
           handles Claude preamble, backtick fences, partial articles
           prompt hardened — explicit empty string for missing fields,
           escape instruction for HTML double quotes in body
   ============================================================ */
  ...
  <div class="sct-card sct-hidden" id="sct-success">
    <div class="sct-card-body">
      <div class="sct-success">
        ...
        <br><button class="sct-reset-btn" onclick="sctResetAll()">+ Transcribe Another Article</button>
      </div>
    </div>
  </div>
</div>
...
- The body field contains HTML — escape any double quotes inside HTML attribute values as \\" to keep JSON valid
