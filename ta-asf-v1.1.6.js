/* ============================================================
   ...
   Companion stylesheet: ta-asf-v1.1.6.css
   Reference spec:       v1.1 ASF layout + unified sidebar picker
...
(function () {
  ...
  log('mounted · v' + VERSION + ' · hot-fix: action.getAttribute → el.getAttribute (picker-insert-image / picker-set-tab / picker-toggle-bundle / set-article-type now actually work) + picker thumb grid 3-across.');
})();
