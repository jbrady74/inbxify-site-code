      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          '<div class="ix-hdr-left">' +
            ...
            '<div>' +
              '<h3>Studio</h3>' +
              '<div class="ix-hdr-sub">' + esc(getTitleName()) + '</div>' +
            '</div>' +
          '</div>' +
          // v1.3.1: banner mount sits right of title. Renders empty
          // until renderTriageBanner() populates it (gated on
