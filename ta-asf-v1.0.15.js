...
(function () {
  ...
  log('mounted · v' + VERSION + ' · Body editing enabled in create mode via Studio v1.4.0\'s mode:"local" body editor. bodyHtml + bodyStatus now travel with createAsset payload.');
})();
