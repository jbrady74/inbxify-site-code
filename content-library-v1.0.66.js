...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-tabrow{display:flex;align-items:flex-end;justify-content:space-between;gap:40px;margin-bottom:6px}',
  ...
  var S = {
    ...
    assignStatus: 'unassigned', // v1.0.58: default to articles with NO PubPlan
  ...
  function init() {
    ...
    console.log('[ASSET-LIBRARY v1.0.66] Init:', {
