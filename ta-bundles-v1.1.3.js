/* ============================================================
   ta-bundles-v1.1.3.js
   ============================================================
   INBXIFY · Bundles Workspace · Cut 2 ship 2.5 of 3
   (Action bar alignment + flush-bottom polish)
   ...
   ─── Page load order on T-A page ───
     ...
     2. ta-bundles-v1.1.3.js             (this file)
     3. ta-bundles-v1.1.3.css            (paired — full replacement
                                          of v1.1.2.css; remove the
                                          old <link>)
...
(function () {
  ...
  // v1.1.3: Mirror #bdl-root's bounding rect onto the fixed-position cascade
  // anchor so the action bar / cascade panel sits flush above the file list,
  // not spanning the full viewport. Called after every renderCascadeAnchor()
  ...
  function syncCascadeAnchorToContainer() {
    ...
    // Defensive: don't apply zero dims if root is currently hidden
