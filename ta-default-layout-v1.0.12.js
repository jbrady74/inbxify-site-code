/* ============================================================================
   ta-default-layout-v1.0.12.js
   INBXIFY · T-A Studio · Default Layout tab  (Workstream K-2)

   v1.0.12 — added fixed gold Header (HC-TDL-HDR) at slot #1, directly below the
            masthead: non-draggable, non-deletable chrome (NOT a palette block),
            placeholder "No. 000 / Sample Title / January 1, 2005". Gold #C4A35A,
            Fraunces, inline !important. The Header always renders first; movable
            blocks sit below it. (Distinct from the Greeting palette block.)
...
(function () {
    ...
    S.root.innerHTML =
      ...
      '<div class="tdl-grid">' +
        ...
        '<div class="tdl-stack-wrap">' +
          ...
          // non-deletable chrome (like the masthead) — NOT a palette block. Gold
          // band with placeholder Issue No. / Title / Date. Inline !important so
          // the page's stylesheets can't suppress it. Tucks under the masthead
          // (masthead has square bottom corners). Placeholder copy is fixed text.
          '<div class="tdl-fixed-hdr" style="width:65%;margin:-12px auto 14px;padding:14px 22px;background:#C4A35A !important;color:#1A1A1A !important;border-radius:0 0 5px 5px;display:flex;flex-direction:column;align-items:center;text-align:center;font-family:\'Fraunces\',Georgia,serif;">' +
            '<div style="font-weight:700;font-size:13px;letter-spacing:.08em;text-transform:uppercase;">No. 000</div>' +
            '<div style="font-weight:600;font-size:22px;line-height:1.15;margin:3px 0;">Sample Title</div>' +
            '<div style="font-size:13px;opacity:.85;">January 1, 2005</div>' +
            '<div style="margin-top:8px;font-family:var(--tdl-font-body),sans-serif;font-size:10px;letter-spacing:.1em;text-transform:uppercase;opacity:.6;">Header \u00b7 always first \u00b7 fixed</div>' +
          '</div>' +
  ...
  function mount() {
    ...
    render();
    S.mounted = true;
    console.log('[tdl] Default Layout tab mounted \u00b7 v1.0.12 \u00b7 blocks:', S.blocks.length,
