...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          '<div class="ix-hdr-left">' +
            ...
            '</div>' +
          '</div>' +
          // v1.3.1: banner mount sits right of title, left of
          // version badge. Renders empty until renderTriageBanner()
          // populates it (gated on STD_MONITOR.preprocessing > 0).
          '<div class="ix-hdr-right">' +
            '<div id="std-triage-banner" class="std-triage-banner-slot"></div>' +
            '<span class="ix-badge">v1.4.1</span>' +
          '</div>' +
        '</div>' +
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.4.9 mounted \u2014 Intake default subtab; \u2014 Generate tab renamed to "Ad Reformat" (key generator, reformatter unchanged); NEW "Generate" tab (key adgen, dispatches std:panel:adgen, mounts #std-adgen-mount) for the from-scratch ad creator.');
  });
