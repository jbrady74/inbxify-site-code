...
(function () {
  ...
  log('mounted · v' + VERSION + ' · createAsset payload now includes CMS refs (customer/product/mnls/newsletter/revenueType). Ref pickers in create mode write locally and travel out with first save instead of POSTing updateArticleRef to a non-existent record.');
})();
