...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-tabrow{display:flex;align-items:flex-end;justify-content:space-between;gap:16px;border-bottom:2px solid #e8e4d8;margin-bottom:14px}',
    '.cl-tabrow .cl-mtabs{border-bottom:none;margin-bottom:0;flex:0 0 auto}',
    '.cl-searchbox{position:relative;flex:0 1 300px;margin-bottom:7px}',
    '.cl-searchbox .cl-search-ico{position:absolute;left:11px;top:50%;transform:translateY(-50%);width:13px;height:13px;opacity:.4;pointer-events:none}',
    '.cl-search-input{width:100%;font-family:"DM Sans",system-ui,sans-serif;font-size:13px;padding:8px 12px 8px 32px;border:1.5px solid #e8e4d8;border-radius:8px;background:#fff;color:#1a3a3a;outline:none;transition:border-color .15s,box-shadow .15s}',
    ...
    '.cl-seg button{font-family:"DM Mono",monospace;font-size:10px;letter-spacing:.03em;padding:5px 11px;border:none;background:transparent;color:#5a6a5a;cursor:pointer;transition:all .12s;border-right:1px solid #e3dfd2}',
