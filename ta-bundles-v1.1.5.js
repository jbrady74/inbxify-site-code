/* ============================================================
   ta-bundles-v1.1.5.js
   ============================================================
   INBXIFY · Bundles Workspace · Cut 2 ship 3 of 3 — FINAL
   (Save wiring + cascade red-border carry)
   ...
   ─── Page load order on T-A page ───
     ...
     3. ta-bundles-v1.1.5.js             (this file)
     4. ta-bundles-v1.1.5.css            (paired — full replacement
                                          of v1.1.4.css; remove the
                                          old <link>)
