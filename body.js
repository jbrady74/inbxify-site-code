...
- [REBUILD] Section 1: Mobile Nav v2.0 — complete rewrite
  * DOMContentLoaded wrapper (timing fix)
  * New class names: .inbx-nav-panel, .inbx-nav-overlay
  * Hamburger opens only (no morph)
  * Close X button injected inside panel
  * Panel hidden by default (visibility:hidden + translateX)
  * PubPlan event isolation
  * Subscribe/Contact popup wiring
  * ARIA accessibility
- [REMOVED] Old Section 9 (duplicate mobile nav handler)
