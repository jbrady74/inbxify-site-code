...
- [FIX] Section 13: Added null guards on closeBtn, contentWrapper,
  successWrapper, emailError, zipError, submitBtn — prevents crash
  if any inner subscribe popup element is missing from the DOM
- [FIX] Section 16: Added null guard on backdrop element — prevents
  crash on pages without #inbx-backdrop div
...
/* ── 13. SUBSCRIBE POPUP ────────────────────────── */
/* v1.6 FIX: Added null guards on all inner elements */
(function() {
...
/* ── 16. SIGN IN BACKDROP ───────────────────────── */
/* v1.6 FIX: Added null guard on backdrop */
(function () {
