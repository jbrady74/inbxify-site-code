// ============================================================
// ta-studio-v1.2.9.js
// INBXIFY TA Studio — Phase 4 / S13 Step 1
// 6-tab shell + .std-subtab → ix-btn--pill migration (TD-166).
//
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          '<div class="ix-hdr-left">' +
            ...
            '</div>' +
          '</div>' +
          '<span class="ix-badge">v1.2.9</span>' +
        '</div>' +
        // ── 6-tab strip (S13 / TD-166) ──
        // .std-subtabs wrapper retained for layout. Buttons use
        // canonical ix-btn ix-btn--pill (.active synonym from
        // ix-buttons v1.0.1). Default active = 'assembler' (Q-A
        // lock; flips to 'input' in S14).
        '<div class="std-subtabs">' +
          '<button class="ix-btn ix-btn--pill" data-std-panel="input">' +
            '<span class="std-subtab-icon">\u2B06</span>' +
            '<span>Inputs</span>' +
          '</button>' +
          '<button class="ix-btn ix-btn--pill" data-std-panel="components">' +
            '<span class="std-subtab-icon">\u25A3</span>' +
            '<span>Components</span>' +
          '</button>' +
          '<button class="ix-btn ix-btn--pill active" data-std-panel="assembler">' +
            '<span class="std-subtab-icon">\u29BE</span>' +
            '<span>Assembler</span>' +
          '</button>' +
          '<button class="ix-btn ix-btn--pill" data-std-panel="transcriber">' +
            '<span class="std-subtab-icon">\u270E</span>' +
            '<span>Transcriber</span>' +
          '</button>' +
          '<button class="ix-btn ix-btn--pill" data-std-panel="converter">' +
            '<span class="std-subtab-icon">\u21BB</span>' +
            '<span>Converter</span>' +
          '</button>' +
          '<button class="ix-btn ix-btn--pill" data-std-panel="generator">' +
            '<span class="std-subtab-icon">\u2728</span>' +
            '<span>Generator</span>' +
          '</button>' +
        '</div>' +
    ...
    console.log('\u29BE Studio v1.2.9 mounted \u2014 6-tab shell (Inputs | Components | Assembler | Transcriber | Converter | Generator) + .std-subtab \u2192 ix-btn--pill (TD-166). Default tab: Assembler (Q-A parallel-run). Transcriber/Converter dispatch std:panel:* CustomEvents on activation.');
  });
