...
.cm-tabs{display:flex;gap:4px;margin-bottom:14px;align-items:center;flex-wrap:wrap}
.cm-tab{font-family:'DM Mono',monospace;font-size:10px;letter-spacing:.04em;padding:5px 12px;border-radius:4px;border:1.5px solid #e8e4d8;background:#fff;color:#5a6a5a;cursor:pointer;transition:all .15s;display:flex;align-items:center;gap:5px}
...
<div class="cm-root">
  <div class="cm-hdr">
    ...
    <span class="cm-badge">v1.0.1</span>
  </div>
  ...
  loadFiles();
  loadFolderCounts();
  console.log('\u{1F4C2} Uploads Processor v1.0.1 mounted');
});
