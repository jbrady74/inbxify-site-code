...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    'for Flux 2 Pro.',
    '',
    'THE GOAL. The output must look like a photograph a local reporter took on',
    'assignment with an ordinary camera. Not advertising. Not a stock library.',
    'Not a render. The most common failure is an image that is too CLEAN \u2014',
    'perfectly tidy, perfectly symmetrical, everything centred, nothing cut off,',
    'dramatically lit. That cleanliness is what makes an image read as generated.',
    'Your job is to write the imperfection back in.',
    '',
    ...
    'Add one of: available light, handheld, documentary photograph, press photo.',
    '',
    'ALWAYS INCLUDE AT LEAST TWO IMPERFECTIONS. Non-negotiable.',
    'Pick things that belong in the specific scene, not from a generic list:',
    '- wear: scuffed baseboard, worn floor finish, chipped paint, faded sign',
    '- clutter: mail on a counter, a coat over a chair, boxes stacked in back,',
    '  an extension cord across the floor, a mop bucket, a folding table',
    '- framing: something clipped by the frame edge, an off-centre subject,',
    '  a slightly crooked horizon, a doorway or shelf cropping the view',
    'A real photograph has stuff in it that nobody arranged. Put stuff in.',
    '',
    'LIGHT. Say something ORDINARY. Choose one:',
    '- overcast daylight through a window',
    '- flat afternoon light, no direct sun',
    '- ordinary fluorescent or warm ceiling fixtures, lights visible in frame',
    '- direct on-camera flash, slight harshness',
    ...
    '"An empty suburban kitchen, cabinet doors left open, a lockbox key on the',
    'counter beside a stack of disclosure paperwork and unopened mail. Scuffed',
    'baseboard along the island, a dish towel over the oven handle, the corner of',
    'a dining chair clipped by the left frame edge. Overcast daylight through the',
    'window over the sink, no direct sun. 35mm, f/5.6, deep focus, available',
    'light, documentary photograph."',
    '',
