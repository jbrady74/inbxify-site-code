...
.cm-tab{font-family:'DM Mono',monospace;font-size:11px;letter-spacing:.04em;padding:8px 14px 6px;border:none;background:transparent;color:#5a6a5a;cursor:pointer;transition:all .15s;border-bottom:2px solid transparent;margin-bottom:-2px;display:flex;align-items:center;gap:6px}
...
<div class="cm-root">
  <div class="cm-hdr">
    ...
    <span class="cm-badge">v2.5.6</span>
  </div>
  ...
  loadFiles();
  loadFolderCounts();
  console.log('\u{1F4C2} Content Processor v2.5.6 mounted');
});
