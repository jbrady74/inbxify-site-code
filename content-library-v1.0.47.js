...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-searchrail{gap:10px}',
    '.cl-filter-toggle{flex:0 0 auto;width:38px;height:38px;display:flex;align-items:center;justify-content:center;align-self:flex-end;margin-bottom:1px}',
    '.cl-filter-toggle[data-active="true"]{background:#185fa5 !important;color:#fff !important;border-color:#185fa5 !important}',
  ...
  function render() {
    ...
    // v1.0.47 (#1): filter toggle icon — shows/hides the filter bar (#2)
    h += '<button class="ix-btn ix-btn--icon cl-filter-toggle" data-active="' + (S.showFilters ? 'true' : 'false') +
         '" title="Filters" aria-label="Toggle filters" onclick="_clToggleFilters()">' +
         '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M2 4h14M5 9h8M7 14h4"/></svg></button>';
