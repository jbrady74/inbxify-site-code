...
(function () {
    ...
    S.root.innerHTML =
      ...
      '<div class="tdl-grid">' +
        ...
        '<div class="tdl-stack-wrap">' +
          ...
          '<div class="tdl-fixed-mast" style="width:65%;height:80px;margin:0 auto 12px;background:#142e2e;color:#fff;border-radius:5px 5px 0 0;display:flex;align-items:center;justify-content:center;font-family:\'Fraunces\',Georgia,serif;font-weight:600;font-size:26px;letter-spacing:-.01em;">Wyckoff Living Now</div>' +
  ...
  function mount() {
    ...
    render();
    S.mounted = true;
    console.log('[tdl] Default Layout tab mounted \u00b7 v1.0.10 \u00b7 blocks:', S.blocks.length,
