/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.6.1.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.6.1.css (matched pair — load both)

   ── v0.6.1 — CONTROLS COLLAPSE TO ICONS ──
...
(function () {
  ...
  /* v0.6.1 — the meta line is gone. Size, dimensions and word counts
    ...
    try {
      window.localStorage.setItem(VIEW_KEY, JSON.stringify({
        ...
        /* q and typeFilter are deliberately NOT persisted — see the
           v0.6.1 note. A question asked last session must not silently
           filter this one. */
      }));
    } catch (e) {}
  }
