/* ============================================================
   ta-asset-workbench-v0.8.4.js
   INBXIFY TA Studio — Asset Workbench (detail/management surface)
   Companion stylesheet: ta-asset-workbench-v0.8.4.css
        ...
        '<aside class="awb-sidebar">' +
          sbSection('Article Info', [
            ...
            sbRefField('Title-Admin',
              ...
              fld(a, ['title-admin'])),
            sbField('Writer', fld(a, ['writer-name', 'writername'])),
            sbField('Writer Title', fld(a, ['writer-title', 'writertitle'])),
            sbField('Co-Writer', fld(a, ['co-writername', 'co-writer-name'])),
            sbField('Co-Writer Title', fld(a, ['co-writertitle', 'co-writer-title'])),
