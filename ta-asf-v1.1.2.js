/* ============================================================
   ...
   Companion stylesheet: ta-asf-v1.1.2.css
...
(function () {
  ...
  log('mounted · v' + VERSION + ' · ASF v2 layout — Chunk 2 of 4 + Trix CDN auto-load (inline body editor in create mode; sidebar picker swap arrives in Chunk 3).');
})();
