...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.4.3 mounted \u2014 \u24d8 info popover now lands on ALL content panels (Components/Assembler/Transcriber/Converter/Generator) via expanded heading selector + per-panel MutationObserver (beats async sibling-mount timing). Inputs + Create intentionally skipped (no panel heading to host).');
  });
