...
(function () {
  ...
  function parseAds() {
    ...
    try {
      ...
      var arr = Array.isArray(data) ? data : (data.ads || []);
      return arr.filter(function (a) { return a && a.img && a.url; });
    } catch (e) { return []; }
  }
  ...
  function createAdEl(ad) {
    ...
    div.innerHTML =
      ...
      '<img src="' + ad.img + '" alt="' + (ad.name || 'Local Partner') + '" loading="lazy">' +
      '</a>';
    return div;
  }
