/* ============================================================================
   ta-default-layout-v1.0.3.js
   INBXIFY · T-A Studio · Default Layout tab  (Workstream K-2)

   v1.0.3 — layout + drag overhaul:
     • Columns reordered: ADD BLOCK (left) · block stack (center) · TEMPLATE
       context + switches (right). Template box moved from left to right.
     • New page header mirroring the Issues page: icon tile + serif title
       "Default Newsletter Layout" + uppercase mono subtitle + heavy rule.
       Renamed from "Default Layout" to "Default Newsletter Layout".
     • Drag-reorder rebuilt: cards are drop targets (insert before/after by
       cursor midpoint) instead of thin between-block strips that were
       nearly unhittable. Palette drag-to-insert and drop-to-append also work.
...
(function () {
  ...
  function mount() {
    ...
    render();
    S.mounted = true;
    console.log('[tdl] Default Layout tab mounted \u00b7 v1.0.3 \u00b7 blocks:', S.blocks.length,
