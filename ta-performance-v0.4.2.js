/* ============================================================
   ...
   Pairs with ta-performance-v0.4.2.css.
...
(function () {
  ...
  function openNlModal(nl) {
    ...
    overlay.innerHTML =
      ...
      + '<div class="nlm-card nlm-content-card"><h4>Content \u2014 every item in this send</h4><table>'
  ...
  function render() {
    ...
    view.innerHTML = '<div class="ta-perf__card perf-nl-card"><table>'
      + '<thead><tr><th style="width:30px"></th><th>Newsletter</th><th>Status</th>'
      ...
      + (NLS.map(rowNl).join('') || '<tr><td colspan="9">' + dash('no newsletters found \u2014 is the newsletter-wrapper list on the page?') + '</td></tr>')
      + '</tbody></table></div>';
  }
...
/* End of ta-performance-v0.4.2.js */
