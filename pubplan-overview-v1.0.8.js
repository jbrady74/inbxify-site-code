// ============================================================
// pubplan-overview-v1.0.8.js
//
// Compact PubPlan overview on the T-A page.
// Reads from collection-list-110 .pubplan-slot-wrapper DOM.
// Hides old column grid + modal. Injects header from JS.
// Editing lives on detail page (/publication-plan/xxx).
//
// FA/TS: article title main, product library name small below
// TF: customer name main, category label above tiles
// TF LBP: 1 filled tile + 4 empty to maintain alignment
// TF empty: 5 empty tiles + placeholder for cat label alignment
// EV: event name from .events-wrapper lookup
// RE: address from .re-wrapper lookup
// All tiles fixed 48px height for cross-column alignment.
// Header matches Content Processor style.
//
