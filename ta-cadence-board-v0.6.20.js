/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.6.20.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.6.20.css — INDEPENDENTLY VERSIONED.
  ...
  function heroHtml() {
    ...
    return '<div class="ixcb-hero">' +
      ...
      '<div class="ixcb-setup">' +
        '<div class="ixcb-gate">' +
          '<div class="ixcb-ref">' +
            (lastLbl ? 'Last sent <b>' + esc(lastLbl) + '</b>' : 'Nothing sent yet on this title') +
            (hiLbl ? '<span class="ixcb-ref-sep">\u00b7</span>Highest plan <b>' + esc(hiLbl) + '</b>' : '') +
          '</div>' +
