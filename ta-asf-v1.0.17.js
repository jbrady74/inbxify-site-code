/* ============================================================
   ...
   Companion stylesheet: ta-asf-v1.0.12.css (.dirty contract: gold 2px border)
...
(function () {
  ...
  log('mounted · v' + VERSION + ' · open() accepts { mode:"create", prefill: {...} } for TD-186 Transcriber → ASF launch path.');
})();
