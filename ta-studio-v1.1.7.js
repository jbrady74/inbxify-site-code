// ============================================================
// ta-studio-v1.1.7.js
// INBXIFY TA Studio — Components tab (read surface) + archive/delete
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          '<div class="ix-hdr-left">' +
            ...
            '</div>' +
          '</div>' +
          '<span class="ix-badge">v1.1.7</span>' +
        '</div>' +
    ...
    // ─── Attach stub (6A) ───
    function cmpHandleAttachStub(mediaId) {
      var it = cmpFindItem(mediaId);
      if (!it) return;
      console.log('[TA-STUDIO v1.1.7] Attach stub invoked for MEDIA:', mediaId, it.name);
      showStudioToast('Attach wiring ships in v1.1.8.');
    }
    ...
    // ── Init ──
    renderAssembler();
    console.log('\u29BE Studio v1.1.7 mounted \u2014 Components tab (read surface + archive + hard-delete)');
  });
