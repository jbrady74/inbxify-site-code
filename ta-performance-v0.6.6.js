...
(function () {
  ...
  function viewDrill(custId) {
    ...
    return '<span class="perf-back" data-perf-back>\u2190 All advertisers</span>'
      ...
      + '<thead><tr><th>Issue</th><th>Date</th><th>Slot</th><th>Kind</th>'
      ...
      + '<tbody>' + (issueRows || '<tr><td colspan="8">' + dash('no ingested placements') + '</td></tr>') + '</tbody></table>'
