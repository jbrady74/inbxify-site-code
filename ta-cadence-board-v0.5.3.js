/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.5.3.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.5.3.css (matched pair — load both)

   ── v0.5.3 — CONTROLS COLLAPSE TO ICONS ──
    ...
    try {
      window.localStorage.setItem(VIEW_KEY, JSON.stringify({
        ...
        /* q and typeFilter are deliberately NOT persisted — see the
           v0.5.3 note. A question asked last session must not silently
           filter this one. */
      }));
    } catch (e) {}
  }
