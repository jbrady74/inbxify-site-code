/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.6.2.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.6.2.css (matched pair — load both)

   ── v0.6.2 — CONTROLS COLLAPSE TO ICONS ──
...
(function () {
  ...
  var S = {
    ...
    typeFilter: 'article', // v0.6.2 — Articles are most of the work
  ...
  /* v0.6.2 — the meta line is gone. Size, dimensions and word counts
    ...
    try {
      window.localStorage.setItem(VIEW_KEY, JSON.stringify({
        ...
        /* q and typeFilter are deliberately NOT persisted — see the
           v0.6.2 note. A question asked last session must not silently
           filter this one. */
      }));
    } catch (e) {}
  }
