/* ============================================================
   ...
   Pairs with ta-intake-manager-v2.0.0.css.
   ============================================================
...
(function () {
  ...
  var S = {
    ...
    l1:            'bundles',     // 'bundles' | 'loose'  — top-level tab
  ...
  function init() {
    ...
    if (window.console && console.log) console.log('[Intake] v' + FILE_VERSION + ' loaded (ta-intake-manager) — subtabs + archive/restore + attach/create cascade');
  }
  ...
  function render() {
    ...
    var l1Html =
      '<div class="bdl-l1">' +
        '<button class="bdl-l1-tab' + (S.l1 === 'bundles' ? ' is-active' : '') + '" data-bdl-l1="bundles">Bundles</button>' +
        '<button class="bdl-l1-tab' + (S.l1 === 'loose'   ? ' is-active' : '') + '" data-bdl-l1="loose">Loose files</button>' +
