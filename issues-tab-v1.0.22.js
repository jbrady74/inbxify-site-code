...
(function () {
  ...
  // ── Make webhooks (v1.0.22 — from TA_CONFIG) ──
  // Read at call time, not at load time, so a config edit takes
  // effect on the next click rather than needing a hard reload.
  // No literals and no fallbacks: a fallback would put the URL
  // back into this public file, which is the whole problem.
  ...
  function promoteToNext(btn) {
    ...
    var promoteUrl = requireMakeUrl('makePromoteNext', 'promote');
