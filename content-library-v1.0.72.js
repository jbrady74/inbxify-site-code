...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-thead{display:grid;grid-template-columns:44px 468px 351px 211px 211px 170px;gap:0;background:#f4f1ea;border-bottom:2px solid #c4a35a;border-radius:7px 7px 0 0;padding:0;align-items:stretch;overflow:hidden}',
    ...
    '.cl-card{background:#fff;border:1.5px solid #e8e4d8;border-top:none;transition:border-color .12s;overflow:hidden}',
    ...
    '.cl-card-main{display:grid;grid-template-columns:44px 468px 351px 211px 211px 170px;gap:0;align-items:center;padding:11px 0;cursor:pointer}',
    ...
    '.cl-cell .ix-btn--sm{min-width:64px;white-space:nowrap;padding-left:12px !important;padding-right:12px !important;text-align:center;justify-content:center;overflow:visible}',
  ...
  function render() {
    ...
    if (!items.length) {
      ...
      items.forEach(function (item) {
        ...
        h += '<div class="cl-card ' + (isEd ? 'editing' : '') + (isSel ? ' is-selected' : '') + '">';
