...
(function () {
  ...
  function renderConverter(targetEl, initialTool) {
    ...
    function finishUpscale(r) {
      ...
      const newName = baseName + '-upscaled' + ext;
  ...
  console.log('\u21BB InbxConverter v' + VERSION + ' loaded (Upscale single-panel flow + browser-side alpha preservation)');
})();
