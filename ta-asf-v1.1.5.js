/* ============================================================
   ...
   Companion stylesheet: ta-asf-v1.1.5.css
...
(function () {
  ...
  log('mounted · v' + VERSION + ' · ASF v1.1.x complete + unified sidebar picker (main · og · inline all use the same sidebar swap; legacy modal kept for ref pickers only).');
})();
