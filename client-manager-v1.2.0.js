...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var CM_VERSION = '1.2.0';   // v1.2.0 — the mount log said 1.0.2 while the file said 1.1.4
  ...
  function cmSameValue(sent, got) {
    if (typeof sent === 'boolean' || typeof got === 'boolean') {
      ...
      .then(function (body) {
        ...
        keys.forEach(function (k) {
          if (Object.prototype.hasOwnProperty.call(echoed, k) &&
              cmSameValue(changes[k], echoed[k])) okKeys.push(k);
          else badKeys.push(k);
        });
