    ...
    if (!pend && sel.length) {
      ...
      html = '<div class="ixcb-saved">' + chips +
             '<button type="button" class="ixcb-edit" data-ixcb="slate-pop" ' +
               ...
               'title="Change issue assignment">\u270E</button></div>';
    } else {
      var t;
      ...
      rows +=
        '<tr class="ixcb-sl-row' + (dv === 'not-for-newsletter' ? ' ixcb-sl-row--out' : '') + '">' +
          ...
          '<td class="ixcb-sl-sec" title="' + esc(r.section || '') + '">' +
            esc(r.section || '\u2014') + '</td>' +
          '<td class="ixcb-asn' + (popOpen && S.slatePop.kind === 'typ' ? ' ixcb-asn--open' : '') + '">' +
            slateCell(r, 'typ', SLATE_TYPES, tv, 'Type at intake', '') + '</td>' +
  ...
  function overviewBody() {
    ...
    return '<div class="ixcb-sl">' +
      ...
      '<div class="ixcb-sl-tw"><table class="ixcb-sl-tbl">' +
        ...
        '</colgroup>' +
        '<thead><tr>' +
          '<th class="ixcb-th-r">Pg</th><th>Print Section</th><th>Type</th><th>Title</th>' +
          ...
          '<th>Issue Assignment</th><th>Status</th><th></th>' +
