...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-tabrow.cl-tabrow{display:flex;align-items:flex-end;justify-content:space-between;gap:40px;margin-bottom:36px;background-color:#FAF9F5 !important;padding:0 20px;border-bottom:1px solid #ece8dc}',
    '.cl-tabrow .cl-mtabs.std-subtabs.std-subtabs{margin-bottom:0;flex:0 0 auto;border-bottom:none !important;background-color:transparent !important;padding:0}',
    ...
    '.cl-searchrail{flex:1 1 520px;max-width:640px;display:flex;align-items:flex-end}',
    ...
    '.cl-filter-toggle[data-active="true"]{background:#fff !important;color:#a8842f !important;border:1.5px solid #c4a35a !important;box-shadow:0 0 0 3px rgba(196,163,90,.12)}',
