...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      // The expand icon button — small dark circle, top-right corner.
      '.ix-expand-icon {',
      '  position: absolute;',
      '  top: 4px; right: 4px;',
      '  width: 22px; height: 22px;',
      '  border-radius: 50%;',
      '  background: #5b7fff !important;',  /* v1.0.1: corporate blue — visible on any image */
      ...
      '  background: #4060dd !important;','  /* v1.0.1: darker blue on hover */
