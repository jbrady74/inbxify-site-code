// ============================================================
// content-manager-v1.0.9.js
// INBXIFY Content Manager — System 2 UI
// v1.0.9: fix spacebar/keypress bubbling to Webflow tab handler killing modal
//         customer selection filters CMS item dropdown
//         customer change resets item/new state but preserves product type
// ============================================================
...
<div class="cm-root">
  ...
  window.cmSetCust = val => {
    ...
    // __none__ = No Customer / Unsponsored — valid, clears item filter
    // Changing customer resets item selection but preserves product type + all form fields
    // CMS item dropdown re-filters automatically to show only items for selected customer
