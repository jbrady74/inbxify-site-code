/* ============================================================
   ...
   Companion stylesheet: ta-asf-v1.1.3.css
   Reference spec:       v1.1 ASF layout — Chunk 3 of 4
...
(function () {
  ...
  log('mounted · v' + VERSION + ' · ASF v2 layout — Chunk 3 of 4 + inline image picker (sidebar swap, by-bundle, Available/Attached tabs).');
})();
