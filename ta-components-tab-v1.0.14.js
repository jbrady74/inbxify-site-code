/* ============================================================
   ta-components-tab-v1.0.14.js
   INBXIFY TA Studio — Components tab
   ============================================================

   v1.0.14 — Expand icon = own .cmp-expand-btn (text +, self-contained, no SVG/lightbox dependency)
    ...
    if (it.imageUrl) {
      thumb =
        '<div class="cmp-row-thumb cmp-expand-host">' +
          ...
          '<button type="button" class="cmp-expand-btn" data-cmp-card-action="expand-preview" aria-label="Preview full size">+</button>' +
        '</div>';
    } else {
