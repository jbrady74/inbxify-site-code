  ...
  function loadNlbAssignments() {
    ...
    return fetchJsonResilient(full, 'nlblocks').then(function (resp) {
      ...
      rows.forEach(function (row) {
        ...
        if (!aid) return;
        NLB_ASSIGN[aid] = { pubplanId: fd['publication-plan'] || '', newsletterId: fd['newsletter'] || '' };
      });
      // re-decorate anything already loaded + re-render
  ...
  function render() {
    ...
    if (!items.length) {
      ...
      items.forEach(function (item) {
        ...
        if (item.pubplanName || item.pubplanId) {
