      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          ...
          '<div class="ix-hdr-right">' +
            ...
            '<span class="ix-badge">v1.3.8</span>' +
          '</div>' +
        '</div>' +
        ...
        // std-create-tab is clicked. Positioned absolutely below the
        // tab via inline styles. Click-outside listener wired in
        // setPanel() handler block.
        '<div class="std-create-menu" data-std-create-menu' +
          ' style="display:none;position:absolute;top:46px;right:14px;z-index:200;' +
