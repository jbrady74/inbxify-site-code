...
//         - Convert to JPEG: POST to Scenario B webhook with action=convert_to_jpeg
//         - Transcribe: POST to Scenario B webhook with action=transcribe
//         - Wait for success before updating UI
...
<div class="cm-root">
  <div class="cm-hdr">
    ...
    <span class="cm-badge">v2.4.2</span>
  </div>
  ...
  mount.addEventListener('click', function(e) {
    ...
    if (e.target.closest('[data-cm-pdf-transcribe]')) { processPdfs('transcribe'); return; }
  ...
  loadFiles();
  console.log('\u{1F4C2} Content Processor v2.4.2 mounted');
});
