// ============================================================
// PUBPLAN TILE UI — v5.0.22
// Changes from v5.0.20:
//   FIX #22: Read section-level TF category from
//            .txa-slot-wrapper[data-slot-code="TXA-1"] DOM element
//            directly via getAttribute (not dataset, not state object)
//            — the slot wrapper has data-cat-id bound to CMS
...
(function () {
  ...
  function init() {
    ...
    // FIX #22: Read section-level TF category directly from the TXA-1 slot
    // wrapper DOM element (not from state, not from picker wrapper).
    // The slot wrapper has data-cat-id bound to TXA Category ID in CMS.
