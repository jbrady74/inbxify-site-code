...
(function () {
  ...
  // (K9 — it's a flag). Local Weather is NO LONGER stripped (now a block, v1.0.6).
  var STRIP_TYPES = {
  ...
  function mount() {
    ...
    render();
    S.mounted = true;
    console.log('[tdl] Default Layout tab mounted \u00b7 v1.0.14 \u00b7 blocks:', S.blocks.length,
