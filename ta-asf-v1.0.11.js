...
(function () {
  ...
  log('mounted · v' + VERSION + ' · Per-section edit gating removed — all sections always editable. Readonly determined by S.mode ("readonly" reserved for future hyperlink-to-readonly view). Create mode: sections immediately editable, Save Draft posts createArticle to Scenario G.');
})();
