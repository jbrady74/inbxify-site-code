...
(function () {
  ...
  log('mounted · v' + VERSION + ' · Narrative section: readonly textareas auto-size to content (no clip), edit-mode heights aligned, teaser/summary widths re-balanced 2:1. Section bg unified across all rows.');
})();
