...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    '.cl-seg button.on{background:#1a3a3a;color:#fff;font-weight:600}',
    '.cl-seg button .sgc{font-size:9px;opacity:.55;margin-left:4px}',
    '.cl-seg button.on .sgc{opacity:.85;color:#fff}',
  ...
  var S = {
    ...
    assignStatus: 'all', // all | assigned | available  (v1.0.39: show all by default)
