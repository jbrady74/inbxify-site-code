...
//   FIX #22: Category-only save — selecting any category from dropdown
//            lights up Save button and submits TF-CAT with category ID.
//            Uses tfCategoryDirty flag (user interaction only, not page load).
//            If existing category saved, shows confirm before overwriting.
...
(function () {
  ...
  window.handleTfCategoryChange = function(sel) {
    ...
    // If an existing category is saved, confirm before overwriting
