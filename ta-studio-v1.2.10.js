// ============================================================
// ta-studio-v1.2.10.js
// INBXIFY TA Studio — Phase 4 / S13 Step 1 follow-up
// Tab strip flips ix-btn--pill → ix-btn--tab (Q-G lock).
//
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          '<div class="ix-hdr-left">' +
            ...
            '</div>' +
          '</div>' +
          '<span class="ix-badge">v1.2.10</span>' +
        '</div>' +
    ...
    console.log('\u29BE Studio v1.2.10 mounted \u2014 6-tab shell (Inputs | Components | Assembler | Transcriber | Converter | Generator) + ix-btn--tab variant (TD-166/Q-G). Default tab: Assembler (Q-A parallel-run). Transcriber/Converter dispatch std:panel:* CustomEvents on activation.');
  });
