// ============================================================
// ta-studio-v1.1.7.2.js
// INBXIFY TA Studio — Components tab (patch: titleSlug in delete payload)
//
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // ── Init ──
    renderAssembler();
    console.log('\u29BE Studio v1.1.7.2 mounted \u2014 Components tab (titleSlug in delete payload)');
  });
