// ============================================================
// ta-studio-v1.3.2.js
// INBXIFY TA Studio — Phase 4 / S14 Step 1 (banner data-source fix)
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          ...
          '<div class="ix-hdr-right">' +
            ...
            '<span class="ix-badge">v1.3.2</span>' +
          '</div>' +
        '</div>' +
    ...
    function renderTriageBanner() {
      ...
      el.innerHTML =
        '<div class="ix-modal-banner ix-modal-banner--alert ix-modal-banner--compact' + freshCls + '">' +
          ...
          '<button class="ix-btn ix-btn--primary" data-std-triage-open>Triage \u2192</button>' +
        '</div>';
    }
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.3.2 mounted \u2014 6-tab shell + PDF triage banner (S14 Step 1, banner/modal source aligned). Components surface delegated to InbxComponentsTab via std:panel:components. Banner gates on STD_MONITOR.preprocessing > 0; modal mounts to <body>. Companion module: ix-modals-v1.0.1.css.');
  });
