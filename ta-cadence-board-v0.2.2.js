/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.2.2.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.2.2.css (matched pair — load both)

   ── v0.2.2 — CONTROLS COLLAPSE TO ICONS ──
...
(function () {
  ...
  function issuesBody() {
    ...
    for (var i = 0; i < plans.length; i++) {
      ...
      out +=
        '<article class="ixcb-plan' + (i === 0 ? ' ixcb-next-plan' : '') + '" data-id="' + esc(p.id) + '">' +
