...
(function () {
  ...
  function init() {
    ...
    if (window.console && console.log) console.log('[Intake] v' + FILE_VERSION + ' loaded (ta-intake-manager) — loose-first, activity dots, auto-refresh; subtabs + archive/restore + attach/create cascade');
  }
