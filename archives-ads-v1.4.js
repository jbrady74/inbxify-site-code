/* archives-ads-v1.4.js
 * Mobile/tablet ad injection for Archives page
 * v1.3 — April 5, 2026
 *
 * v1.3 fix: LIST_SELECTOR changed to '.collection-list-120'
 *   — no .w-dyn-items wrapper exists on Archives page
 *   — .w-dyn-item tiles are direct children of .collection-list-120
 *
...
(function () {
  ...
  var LIST_SELECTOR = '.collection-list-120';
