...
//         (Make scenario does CMS field mapping, not JS)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const ADS = Array.from(document.querySelectorAll('.ad-source')).map(el => ({
    id: el.dataset.adId || '',
...
<div class="cm-root">
  <div class="cm-hdr">
    ...
    <span class="cm-badge">v2.1.1</span>
  </div>
  ...
  // ── Init ──
  loadFiles('DONE');
  console.log('\u{1F4C2} Content Manager v2.1.1 mounted');
});
