/* ============================================================
   ipp-picker-v1.3.js — Picker view (Scope A + greeting GR-block write)
   CHANGELOG
...
(function () {
  ...
  function grSetCount(name){
    ...
    if(wrap){ wrap.classList.toggle('warn', n>=Math.floor(f.max*0.9) && n<f.max); wrap.classList.toggle('over', n>=f.max); }
  }
