/* ============================================================
   ta-bundles-v1.1.2.js
   ============================================================
   INBXIFY · Bundles Workspace · Cut 2 ship 2 of 3
   (Tenant filter on asset picker + width fix)
   ...
   ─── Page load order on T-A page ───
     ...
     2. ta-bundles-v1.1.2.js             (this file)
     3. ta-bundles-v1.1.2.css            (paired — full replacement
                                          of v1.1.1.css; remove the
                                          old <link>)
