...
//
// v1.0.2 CHANGES:
//   - FA/TS: article title as main, product library name small below
//   - EV: looks up event name from .events-wrapper[data-label]
//   - RE: looks up address from .re-wrapper[data-label]
//   - TF: customer name as main display
//   - TF/LBP: 1 tile + spacer to match 5-tile height
//
