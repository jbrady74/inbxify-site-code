...
//            oldest-created-first. Reads data-article-status and
...
(function () {
  ...
  // Oldest created first; undated items sink to the bottom, A-Z.
  // If NOTHING is dated, degrade cleanly to the old A-Z ordering.
