...
(function () {
    ...
    function processUpscale(dataUrl, file) {
      ...
      fetch(UPSCALE_WORKER_URL, {
        ...
        .then(({ ok, j }) => {
          ...
          resultEl.innerHTML = `<div class="cm-conv-result"><div class="cm-conv-result-title">\u2705 Upscaled ${UPSCALE_DEFAULT_SCALE}\u00D7</div><div class="cm-conv-info-row"><span class="cm-conv-info-label">New Size</span><span class="cm-conv-info-val ok">${newSizeKB}</span></div><div class="cm-conv-info-row"><span class="cm-conv-info-label">Vendor</span><span class="cm-conv-info-val">Real-ESRGAN (WaveSpeed)</span></div><div class="cm-conv-info-row"><span class="cm-conv-info-label">Output</span><span class="cm-conv-info-val">What next?</span></div><div class="cm-conv-actions" style="margin-top:10px"><button class="ix-btn ix-btn--secondary" id="cm-conv-download">\u2B07 Download to computer</button><button class="ix-btn ix-btn--primary" id="cm-conv-save-media">\u25A3 Save to Media Library</button><button class="ix-btn ix-btn--danger ix-btn--ghost" id="cm-conv-reset">\u2715 Clear</button><span class="cm-conv-status" id="cm-conv-save-status"></span></div></div>`;
  ...
  console.log('\u21BB InbxConverter v' + VERSION + ' loaded (NEW: Upscale tool via upscaleinbxifycom Worker + Save to Media Library via Scenario B)');
})();
