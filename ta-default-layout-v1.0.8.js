...
(function () {
  ...
  function render() {
    ...
    // Branded section banner: a primary-color band carrying the title name + a
    // "Newsletter Layout" label. Signals "this is the Newsletter Layout
    // workspace" without needing the logo image.
    var bannerHtml =
      '<div class="tdl-banner">' +
        '<div class="tdl-banner-eyebrow">Newsletter Layout</div>' +
        '<div class="tdl-banner-title">' + esc(titleName()) + '</div>' +
        '<div class="tdl-banner-tag">Set the default blocks every new issue starts with.</div>' +
      '</div>';

    S.root.innerHTML =

      // ── Branded color banner, then the section heading + rule. ──
      bannerHtml +
  ...
  function mount() {
    ...
    render();
    S.mounted = true;
    console.log('[tdl] Default Layout tab mounted \u00b7 v1.0.8 \u00b7 blocks:', S.blocks.length,
