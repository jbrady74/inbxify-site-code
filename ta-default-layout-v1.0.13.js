...
(function () {
    ...
    S.root.innerHTML =
      ...
      '<div class="tdl-grid">' +
        ...
        '<div class="tdl-stack-wrap">' +
          ...
          '<div class="tdl-fixed-hdr" style="width:65%;margin:-12px auto 14px;padding:16px 26px;background:#f4a127 !important;color:#1A1A1A !important;border-radius:0 0 5px 5px;display:flex;flex-direction:row;align-items:center;justify-content:space-between;gap:18px;font-family:\'Fraunces\',Georgia,serif;">' +
            '<div style="background:transparent !important;font-weight:700;font-size:14px;letter-spacing:.06em;text-transform:uppercase;white-space:nowrap;">No. 000</div>' +
            '<div style="background:transparent !important;font-weight:600;font-size:22px;line-height:1.1;text-align:center;flex:1;">Sample Title</div>' +
            '<div style="background:transparent !important;font-size:14px;white-space:nowrap;">January 1, 2005</div>' +
          '</div>' +
  ...
  function mount() {
    ...
    render();
    S.mounted = true;
    console.log('[tdl] Default Layout tab mounted \u00b7 v1.0.13 \u00b7 blocks:', S.blocks.length,
