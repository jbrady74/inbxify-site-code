...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // ── State ──
  let FILES     = [];
  let TAB       = 'ready';   // pdf-queue | ready | assigned | archived | hidden | transcriber
  let LOADING   = false;
  let LOAD_ERR  = null;
...
<div class="cm-root">
  <div class="cm-hdr">
    ...
    <span class="cm-badge">v2.4.4</span>
  </div>
  ...
  function setTab(id) {
    ...
    A = freshA();
    // Clear transcribe notice when leaving Transcriber tab
  ...
  loadFiles();
  console.log('\u{1F4C2} Content Processor v2.4.4 mounted');
});
