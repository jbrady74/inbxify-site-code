/* ============================================================
   ta-components-tab-v1.0.13.js
   INBXIFY TA Studio — Components tab
   ============================================================

   v1.0.13 — Expand icon → + plus sign, larger (was tiny magnifier)
        ...
        '<div class="cmp-row-thumb ix-expand-icon-host">' +
          ...
          '<button type="button" class="ix-expand-icon" data-cmp-card-action="expand-preview" aria-label="Preview">' +
            '<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round">' +
              '<line x1="8" y1="3" x2="8" y2="13"></line><line x1="3" y1="8" x2="13" y2="8"></line>' +
            '</svg>' +
          '</button>' +
        '</div>';
    } else {
