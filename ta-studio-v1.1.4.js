// ============================================================
// ta-studio-v1.1.4.js
// INBXIFY TA Studio — Phase 2 Session 4 (body save modal close)
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          '<div class="ix-hdr-left">' +
            ...
            '</div>' +
          '</div>' +
          '<span class="ix-badge">v1.1.4</span>' +
        '</div>' +
    ...
    function renderOpenAssembler(root) {
      ...
      h += '<div style="font-family:var(--ix-font-mono);font-size:10px;color:var(--ix-text-light);letter-spacing:0.04em;text-transform:uppercase">Editable view (v1.1.4) \u00B7 Live save via Scenario G</div>';
      h += '</div>';
    ...
    // ── Init ──
    renderAssembler();
    console.log('\u29BE Studio v1.1.4 mounted \u2014 Phase 2 Session 4 (body save modal close + toast)');
  });
