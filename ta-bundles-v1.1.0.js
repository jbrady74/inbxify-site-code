/* ============================================================
   ta-bundles-v1.1.0.js
   ============================================================
   INBXIFY · Bundles Workspace · Cut 2 ship 1 of 3
   (Selection + cascade shell, no save wiring)
   ...
   ─── Page load order on T-A page ───
     ...
     2. ta-bundles-v1.1.0.js             (this file)
     3. ta-bundles-v1.1.0.css            (paired — full replacement
                                          of v1.0.0.css; remove the
                                          old <link>)
