/* ════════════════════════════════════════════════════════════════
   ta-cadence-board-v0.3.2.js
   INBXIFY T-A — Cadence Board · SKELETON
   Companion: ta-cadence-board-v0.3.2.css (matched pair — load both)

   ── v0.3.2 — CONTROLS COLLAPSE TO ICONS ──
    ...
    try {
      window.localStorage.setItem(VIEW_KEY, JSON.stringify({
        ...
        /* q and typeFilter are deliberately NOT persisted — see the
           v0.3.2 note. A question asked last session must not silently
           filter this one. */
      }));
    } catch (e) {}
  }
