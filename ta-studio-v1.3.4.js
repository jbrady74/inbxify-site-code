// ============================================================
// ta-studio-v1.3.4.js
// INBXIFY TA Studio — Phase 4 / S14 Step 1 (banner refresh)
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          ...
          '<div class="ix-hdr-right">' +
            ...
            '<span class="ix-badge">v1.3.3</span>' +
          '</div>' +
        '</div>' +
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.3.3 mounted \u2014 6-tab shell + PDF triage banner with manual refresh (S14 Step 1). Components surface delegated to InbxComponentsTab via std:panel:components. Banner gates on STD_MONITOR.preprocessing > 0; modal mounts to <body>. Companion module: ix-modals-v1.0.1.css.');
  });
