...
(function () {
  ...
  function parseJson(text) {
    ...
    if (DEBUG) console.warn('[InbxGenerate] unparseable model output:', raw);
  ...
  window.InbxGenerate = { fromBody: fromBody, _model: ANTHROPIC_MODEL, _version: '1.0.10' };
