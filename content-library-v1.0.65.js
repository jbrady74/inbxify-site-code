...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function render() {
    ...
    if (!items.length) {
      ...
      items.forEach(function (item) {
        ...
        h += '<div class="cl-cell cl-assign">';
        if (item.newsletterName || item.newsletterId) {
          h += '<div class="cl-assign-issue">' + esc(item.newsletterName || 'In newsletter') + '</div>';
  ...
  function init() {
    ...
    console.log('[ASSET-LIBRARY v1.0.65] Init:', {
