...
// v2.0–2.5.2: See previous version history
// v1.0.2: Renamed to Uploads Processor, reset versioning
...
<div class="cm-root">
  <div class="cm-hdr">
    ...
    <span class="cm-badge">v1.0.3</span>
  </div>
  ...
  loadFiles();
  loadFolderCounts();
  console.log('\u{1F4C2} Uploads Processor v1.0.3 mounted');
});
