...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    loadStudioPdfCount();
    console.log('\u29BE Studio v1.3.5 mounted \u2014 Inputs monitor panel (S14 Step 2). Default tab: Components. GA4 TD-167 fires on first Inputs activation. PDF triage banner retained. Components surface delegated to InbxComponentsTab via std:panel:components. Companion modules: ix-modals-v1.0.1.css, ix-buttons-v1.0.4.css.');
  });
