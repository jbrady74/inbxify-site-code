...
document.addEventListener('DOMContentLoaded', function () {
  ...
  style.textContent = [
    ...
    // v1.0.59: 6-track grid — 44px select · Title(2fr) · Customer(1.4fr) ·
    // PubPlan(1fr) · Newsletter(1fr) · 150px fixed Actions (pinned right).
    // minmax(0,..) lets the fr tracks shrink + ellipsis instead of overflowing.
    '.cl-thead{display:grid;grid-template-columns:44px minmax(0,2fr) minmax(0,1.4fr) minmax(0,1fr) minmax(0,1fr) 150px;gap:0;background:#1a3a3a;border-radius:7px 7px 0 0;padding:0;align-items:stretch;overflow:hidden}',
    // Header label cell — gold/cream on teal. Sortable ones are buttons.
    '.cl-th{display:flex;align-items:center;font-family:"DM Mono",monospace;font-size:10px;font-weight:600;letter-spacing:.06em;text-transform:uppercase;color:#e9e2cf;padding:11px 10px}',
    '.cl-th-sort{cursor:pointer;background:none;border:none;color:#e9e2cf;font:inherit;letter-spacing:inherit;text-transform:inherit;display:inline-flex;align-items:center;gap:5px;padding:0;transition:color .12s}',
    '.cl-th-sort:hover{color:#fff}',
    '.cl-th-sort.is-active{color:#c4a35a}',
    '.cl-th-chev{font-size:8px;line-height:1;opacity:.55;transition:opacity .12s}',
    '.cl-th-sort.is-active .cl-th-chev{opacity:1}',
    '.cl-th-sel{display:flex;align-items:center;justify-content:center;padding:0}',
    '.cl-th-sub{font-size:8px;color:#a8b0a0;letter-spacing:.03em;text-transform:none;margin-left:4px}',
    // Checkbox (header + row)
    '.cl-check{width:15px;height:15px;cursor:pointer;accent-color:#c4a35a;margin:0}',
    ...
    '.cl-card-main{display:grid;grid-template-columns:44px minmax(0,2fr) minmax(0,1.4fr) minmax(0,1fr) minmax(0,1fr) 150px;gap:0;align-items:center;padding:11px 0;cursor:pointer}',
  ...
  function init() {
    ...
    console.log('[ASSET-LIBRARY v1.0.59] Init:', {
