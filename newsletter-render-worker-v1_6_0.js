// newsletter-render-worker-v1_6_0.js
//
// INBXIFY Newsletter Render Worker v1.6.0
      ...
      try {
        ...
        if (skin) {
          ...
          if (Object.keys(applied).length) {
            blockCtx = Object.assign({}, ctx, applied);
            if (debug) diagnostics.push({ index: i, skin: applied });
          }
        }
        ...
        parts.push(render(tpl, fields, flags, blockCtx));
      } catch (err) {
