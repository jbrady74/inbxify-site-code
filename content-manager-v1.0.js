// ============================================================
// content-manager-v1.0.js
// INBXIFY Content Manager — System 2 UI
// Mounts into #content-manager-mount on T-A page
// Config from window.TA_CONFIG
// v1.0: live Scenario C data, filter tabs, file list,
//       full assignment panel (Product Type → Customer →
//       CMS Item → Element Type), submit logs to console
//       (Make webhook call added once field mapping decided)
// ============================================================
...
<div class="cm-root">
  ...
  window.cmSetFilter = f => {
    ...
    // Reload with correct status filter
