// ============================================================
// ta-studio-v1.1.6.js
// INBXIFY TA Studio — publish-status migration
...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
      ...
      '<div class="std-root">' +
        '<div class="ix-hdr">' +
          '<div class="ix-hdr-left">' +
            ...
            '</div>' +
          '</div>' +
          '<span class="ix-badge">v1.1.6</span>' +
        '</div>' +
    ...
    // ── Init ──
    renderAssembler();
    console.log('\u29BE Studio v1.1.6 mounted \u2014 publish-status migration (closes TD-109 + TD-110)');
  });
